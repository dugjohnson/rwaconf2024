                    ...
                    <div class="mb-2">
                        <div class="mb-2">
                            ...
                            <ul>
                                ...
                                <li>Industry Professional (Literary Agent or Publishing Company Editor):  $299 <sub class="text-2xl text-pink-600">&ast;</sub></li>
                            </ul>
                        </div>
                        <div class="mb-2">
                            ...
                            <ul>
                                ...
                                <li>Industry Professional (Literary Agent or Publishing Company Editor):  $350 <sub class="text-2xl text-pink-600">&ast;</sub></li>
                            </ul>
                        </div>
                        <div class="mb-2">
                            ...
                            <ul>
                                ...
                                <li>Industry Professional (Literary Agent or Publishing Company Editor):  $399 <sub class="text-2xl text-pink-600">&ast;</sub></li>
                            </ul>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="py-4"><p> <sub class="text-2xl text-pink-600">&ast;</sub> A payment plan is available This option includes a $26 convenience
                                fee.</p></div>
