<div {{ $attributes }}>
    <button class="bg-blue-300 hover:bg-blue-800 focus:outline-none  mb-8
            ...
            x-on:click="hotel = ! hotel; if(hotel) registration=false">Hotel Information
    </button>
    <div class="bg-slate relative w-[600px] -left-96" x-show="hotel">
        <div class="mb-2">
            <div class="mb-2">
                ...
                <ul>
                    ...
                    <ul class="list-disc list-inside">
                        ...
                        <li>Triple and quadruple accommodations, when available, is at an additional rate of $25 CAD per
                            person. Children under the age of 18 stay free in the room with an adult, and rollaway beds
        ...
        <section>
            <embed src="/images/BrockPlaza.pdf" width="800" height="800"
